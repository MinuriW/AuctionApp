<%@ page import="java.util.List, com.hcl.seller.domain.AuctionItem" language="java" contentType="text/html; charset=ISO-8859-1"
...
<% if(auctionItems != null){ %>
				...
				<div class="card mb-3">
					...
					<p><small><del><%=a.getStartingPrice()%></del><span>$8</span></small></p>
